...
export const Banner = () => {
  ...
  return (
    <div className="aspect-[5/1] min-h-[248px] flex gap-x-6 p-6 items-center
    bg-gradient-to-r from-[#2e62cb] via-[#0073ff] to-[#3faff5] text-white">
      <div className="max-md:hidden rounded-full size-28 flex items-center justify-center
      bg-white/50">
